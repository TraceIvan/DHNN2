...
def hopfield(train_files, test_files,theta=0.5, time=1000, size=(100,100),threshold=60):
    ...
    after_img.save("yosuke_after_test.jpg")

#Main
#First, you can create a list of input file path
train_pic='yosuke.jpg'
test_pic='yosuke_test.jpg'
#Hopfield network starts!
hopfield(train_files=train_pic, test_files=test_pic, theta=0.5,time=1000,size=(100,100),threshold=120)